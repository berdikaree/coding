			...
			<td>
				<div align="center">
					...
					<form action="index.php" method="POST">
						...
						<input type="text" name="a" value="<?php if (isset($a)) echo $a?>" class="lebar form-control" required placeholder="Angka"> 
						<input type="text" name="b" value="<?php if (isset($b)) echo $b?>" class="lebar form-control" required placeholder="Angka">
						<h3>=</h3>
						<input type="text" name="c" value="<?php if (isset($c)) echo $c?>" class="lebar form-control" placeholder="Angka">
                        ...
                        <input type="submit" name="pangkat" value="^" class="btn btn-primary tebal">
                    ...
                    <br>
                    <div class="input-group">
                        <span class="input-group-addon" style="background-color: blue; color: white; font-weight: bold;">Huruf&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>

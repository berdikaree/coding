...
<header>
  ...
  <div class="row">
    <div class="col s4"><p><center><i class="large material-icons">recent_actors</i></p><a class="waves-effect waves-light btn light-blue accent-2" href="?page=biodata">Biodata</a></center></p></div>
    <div class="col s4"><p><center><i class="large material-icons">view_list</i></p><a class="waves-effect waves-light btn light-blue accent-2" href="?page=LihatNilai">Lihat Nilai</a></center></p></div>
    <div class="col s4"><p><center><i class="large material-icons">power_settings_new</i></p><a class="waves-effect waves-light btn light-blue accent-2" href="?page=logout">Logout</a></center></p></div>
  </div>
  <?php
include "konten.php";
?>

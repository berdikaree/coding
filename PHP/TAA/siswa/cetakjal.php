...
<body>
<?php
$sql= "select * from kelas inner join siswa on siswa.ID_KELAS = kelas.ID_KELAS inner join guru on guru.NIP=kelas.NIP where NIS='".$_SESSION['NIS']."'";
$hasil= mysql_query($sql,$konek);
$record= mysql_fetch_array($hasil);
//ini untuk nilai PAI
$sql2="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '101'";
$hasil2= mysql_query($sql2, $konek);
$pai= mysql_fetch_array($hasil2);
//ini untuk nilai PKN
$sql3="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '102'";
$hasil3= mysql_query($sql3, $konek);
$pkn= mysql_fetch_array($hasil3);
//ini untuk nilai B.ind
$sql4="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '103'";
$hasil4= mysql_query($sql4, $konek);
$bin= mysql_fetch_array($hasil4);
//ini untuk nilai penjas
$sql5="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '104'";
$hasil5= mysql_query($sql5, $konek);
$penjas= mysql_fetch_array($hasil5);
//ini untuk nilai matem
$sql6="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '105'";
$hasil6= mysql_query($sql4, $konek);
$matem= mysql_fetch_array($hasil6);
//ini untuk nilai B.inggris
$sql7="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '106'";
$hasil7= mysql_query($sql7, $konek);
$bing= mysql_fetch_array($hasil7);
//ini untuk nilai fisika
$sql8="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '107'";
$hasil8= mysql_query($sql8, $konek);
$fisika= mysql_fetch_array($hasil8);
//ini untuk nilai kimia
$sql9="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '108'";
$hasil9= mysql_query($sql9, $konek);
$kimia= mysql_fetch_array($hasil9);
//ini untuk nilai kwu
$sql10="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '109'";
$hasil10= mysql_query($sql10, $konek);
$kwu= mysql_fetch_array($hasil10);
//ini untuk nilai pbo
$sql11="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '110'";
$hasil11= mysql_query($sql11, $konek);
$pbo= mysql_fetch_array($hasil11);
//ini untuk nilai pbw
$sql12="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '111'";
$hasil12= mysql_query($sql12, $konek);
$pbw= mysql_fetch_array($hasil12);
//ini untuk nilai bdl
$sql13="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '112'";
$hasil13= mysql_query($sql13, $konek);
$bdl= mysql_fetch_array($hasil13);
//ini untuk nilai ibdw
$sql14="select * from nilai inner join mapel on nilai.ID_MAPEL= mapel.ID_MAPEL inner join siswa on siswa.NIS=nilai.NIS where nilai.NIS='".$_SESSION['NIS']."' and Nilai.ID_MAPEL= '113'";
$hasil14= mysql_query($sql14, $konek);
$ibdw= mysql_fetch_array($hasil14);

//ini untuk jumlah
$jumlah="select sum(nilai) as JUMLAH from nilai where NIS='".$_SESSION['NIS']."'";
$hasill= mysql_query($jumlah, $konek);
$jumlahh= mysql_fetch_array($hasill);

//ini untuk query rata"
$rata="select avg(NILAI) as RATA from nilai where NIS='".$_SESSION['NIS']."'";
...
<center>
  ...
  <table width="950" height="210" border="9" bordercolorlight="#000000">
  ...
  <table width="948" border="0">
    ...
    <tr>
      <td colspan="5"><div align="right">Jombang,09 Februari 2017</div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3"><div align="center"><?php echo $record['NAMA_WALI']; ?></div></td>
      <td width="296"><div align="center">Ir.NURKOYIN,M.Kom</div></td>
      <td width="325"><div align="center"><?php echo $record['NAMA_GURU']; ?></div></td>
    </tr>
  </table>
  </center>
  <p>&nbsp;</p>

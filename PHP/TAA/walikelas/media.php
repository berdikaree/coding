...
<header>
  ...
  <div class="row">
    <div class="col s4"><p><center><i class="large material-icons">perm_identity</i></p><a class="waves-effect waves-light btn light-blue accent-2" href="?page=lihatnilai">Lihat Nilai</a></center></p></div>
    <div class="col s4"><p><center><i class="large material-icons">supervisor_account</i></p><a class="waves-effect waves-light btn light-blue accent-2" href="?page=datanilai">Data Siswa</a></center></p></div>
    <div class="col s4"><p><center><i class="large material-icons">view_list</i></p><a class="waves-effect waves-light btn light-blue accent-2" href="?page=logout">Logout</a></center></p></div>
  </div>
<?php
include "konten.php";
?>

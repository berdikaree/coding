...
if($aksi=="creat_market") {
	...
	$db->buat_toko($_POST["id_vendor"],$_POST["nama_toko"],$loc,$_POST["type"],$_POST["deskripsi"],$_POST["email"],$_POST["no_telp"],$_POST["alamat"],$_POST["kota"],$_POST["kecamatan"],$_POST["provinsi"],$_POST["kode_pos"]);
}

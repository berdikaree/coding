		...
		<div class="main-register">
			<h3>Daftrakan Akun Anda Gratis </h3>
				<form action="handler.php?aksi=daftar_pelanggan" method="post">
					...
					<input type="text" class="user" name="alamat" placeholder="Desa Bukur RT 03 RW 03" required="required"><br>
					...
					<input type="text" class="user" name="kode_pos" placeholder="Kode Pos" required="required"><br>
					<input type="text" class="user" name="no_telp" placeholder="No Telp" required="required"><br>
					...
					<p>Saya Sudah Mempunyai Akun <a href="">Masuk Sekarang</a></p>
				</form>
		</div>

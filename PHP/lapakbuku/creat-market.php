		...
		<div class="main-register">
			<h3>Buat Toko Buku Kamu Sekarang</h3>
				<form action="handler.php?aksi=creat_market" method="post" enctype="multipart/form-data">
					...
					<input type="text" name="nama_toko" placeholder="Nama Toko Kamu" required="required"><br>
					...
					<input type="text" name="no_telp" placeholder="Nomer Telpon kamu"><br>
					<input type="text" name="alamat" required="required" placeholder="Alamat Kamu / Dusun dan Desa"><br>
						<select name="kota">
					...
					<input type="text" name="kode_pos" placeholder="Kode Pos" required="required"><br>

	...
	<div class="header">
			...
			?>
				<ul>
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i><?php echo $_SESSION['pembeli'] ?><span class="caret"></span></a>
					...
					<li class="dropdown head-dpdn">
						<a href="#" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i> Keranjang Saya (<?php echo $ker?>)</a>
					</li> 
					<li class="dropdown head-dpdn">
						<a href="card.html" class="dropdown-toggle"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Cara Pembayaran</a>
					</li> 
					<li class="dropdown head-dpdn">
						<a href="help.html" class="dropdown-toggle"><i class="fa fa-question-circle" aria-hidden="true"></i>Batuan</a>
					</li>
				</ul>
			<?php
		}else{
		...
		<div class="header-three"><!-- header-three -->
			<div class="container">
				...
				<div class="move-text">
					<div class="marquee"><a href="offers.html"> Situs belanja online yang mudah aman & terbukti terpercaya<span>Dapatkan berbagai promo menarik untuk kebutuhan belanja anda </span> <span> Dan jangan kawatir uang pasti kembali 100%</span></a></div>
